run_name="gradient_clipping_lr_decay"
learning_rate=1e-5
bce_with_logits=False

lambdas_pix_last=None
...
run_name="gradient_clipping_higher_lr"
learning_rate=2e-5
bce_with_logits=False
...
run_name="gradient_clipping_loss_rescaling"
learning_rate=1e-5
bce_with_logits=False
...
run_name="gradient_clipping_loss_weights"
learning_rate=1e-5
bce_with_logits=False

lambdas_pix_last='{"bce": 1, "iou": 6, "iou_patch": 0.5, "mae": 25, "mse": 30, "triplet": 3, "reg": 100, "ssim": 10, "cnt": 5, "structure": 5}'
